...
first = str(input("Insert name: "))
second = str(input("Insert adjective: "))
third = str(input("Insert food: "))
fourth = str(input("Insert adjective: "))
fifth = str(input("Insert noun: "))
sixth = str(input("Insert place: "))
seventh = str(input("Insert verb: "))
eighth = str(input("Insert adverb: "))
ninth = str(input("Insert food: "))
tenth = str(input("Insert thing: "))
